        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="price" name="price" placeholder="2.99" value="{{old('price')}}">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="sale_date" name="sale_date" placeholder="2020-08-09" value="{{old('sale_date')}}">
